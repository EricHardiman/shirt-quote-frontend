    ...
    localStorage.getItem("token") === null ?
      ...
      (
        <div className="ui simple dropdown item">
          ...
          <div className="menu">
            <a className="item" href="/quotes">My Quotes</a>
            <a className="item" href="/new_quote">New Quote</a>
            <a className="item" href="/contact">Help</a>
            <div className="divider"></div>
            <p className="item" onClick={() => props.logout()}>Sign Out</p>
          </div>
        </div>
      )
  );
